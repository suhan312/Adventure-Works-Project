...
📌 Project Overview :
An end-to-end data analytics project using the Adventure Works dataset. Performed data cleaning, transformation, analysis, and visualization. Tools used: Excel, Power BI, Tableau, MySQL (SQL). Focused on analyzing Sales, Profit, Production Cost, Total Orders, and Fright charges.
